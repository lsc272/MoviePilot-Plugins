...
- 热门 TMDB 片单：支持热门/高分榜单，以及奥斯卡最佳影片、金球奖、IMDb、豆瓣 Top 250、Letterboxd 动画与综合榜单、Criterion 等公开片单，并可打开原始来源链接。
...
- 缺失订阅：未匹配但具有 TMDB ID 的电影或剧集可直接调用 MoviePilot 添加订阅，自动写入系统默认订阅规则并立即搜索资源。
- 海报交互：点击影视海报可放大查看；点击绿色 Emby 匹配标题可打开对应 Emby 项目页。
...
- 合集海报：首次同步使用四张完整影视海报、柔化背景、渐变遮罩和内置中文展示字体生成竖版合集封面，也可随时重新生成或上传自定义图片。
