const currentImports = {};
      ...
      let moduleMap = {
"./Page":()=>{
      dynamicLoadingCss(["__federation_expose_Page-uXFeSMTc.css","SmartCollectionsApp-BIeMjPzo.css"], false, './Page');
      return __federation_import('./__federation_expose_Page-lv_czq0b.js').then(module =>Object.keys(module).every(item => exportSet.has(item)) ? () => module.default : () => module)},
"./Config":()=>{
...
"./AppPage":()=>{
      dynamicLoadingCss(["SmartCollectionsApp-BIeMjPzo.css"], false, './AppPage');
      return __federation_import('./__federation_expose_AppPage-B7UlmYwG.js').then(module =>Object.keys(module).every(item => exportSet.has(item)) ? () => module.default : () => module)},};
      const seen = {};
